...
pub struct WithContext(super::WithContext<CallbackPersisterAdapter>);

impl From<WithContext> for super::WithContext<CallbackPersisterAdapter> {
    fn from(value: WithContext) -> Self { value.0.clone() }
}

impl From<super::WithContext<CallbackPersisterAdapter>> for WithContext {
    fn from(value: super::WithContext<CallbackPersisterAdapter>) -> Self { Self(value) }
}
...
impl WithContextTransitionOutcome {
    pub fn success(&self) -> Result<Option<Arc<UncheckedProposal>>, ImplementationError> {
        let mut inner = self
            .0
            .write()
            .map_err(|_| ImplementationError::from("Lock is poisoned".to_string()))?;

        let value = inner
            .take()
            .ok_or(ImplementationError::from("Value is already consumed".to_string()))?;
        Ok(value.success().map(|p| Arc::new(UncheckedProposal(p.into()))))
    }
}
...
impl WithContext {
    ...
    pub fn process_res(
        ...
        let res = self.0.process_res(body, &context)?;
        Ok(res.into())
    }
}
...
impl UncheckedProposal {
    ...
    pub fn check_broadcast_suitability(
        ...
        let res = self.0.check_broadcast_suitability(min_fee_rate, |transaction| {
            can_broadcast
...
impl MaybeInputsOwned {
    ...
    pub fn check_inputs_not_owned(
        ...
        let res = self.0.check_inputs_not_owned(|input| {
...
impl MaybeInputsSeen {
    ...
    pub fn check_no_inputs_seen_before(
        ...
        let res = self.0.check_no_inputs_seen_before(|outpoint| {
            is_known
...
impl OutputsUnknown {
    ...
    pub fn identify_receiver_outputs(
        ...
        let res = self.0.identify_receiver_outputs(|output_script| {
            is_receiver_output
...
impl ProvisionalProposal {
    pub fn finalize_proposal(
        ...
        let res = self.0.finalize_proposal(
            |psbt| {
                process_psbt
...
impl PayjoinProposal {
    ...
    pub fn process_res(&self, body: &[u8], ctx: Arc<ClientResponse>) -> Result<(), PersistedError> {
